...
const hideResult = () => byId("resultScreen").style.display = "none";
...
const createModal = (modalMessage, modalDuration, modalBgColor, modalTextColor) => {
	...
	modal.classList.add("modal"); modal.innerText = modalMessage;
	// Modal custom style
	...
	setTimeout(() => deleteModal(modal), Number(modalDuration));
};

const deleteModal = modal => {
	// Slide modal off the screen
